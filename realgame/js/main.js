...
var imageSrcArrayReference = [      //reference for filenames for all images to be loaded
    ...
    "button_load.png",
    "cancel.png",
    "icon_refinery_ore1.png",
    "icon_refinery_ore2.png",
    "icon_refinery_all.png",
    "icon_refinery_refill.png",
    "icon_upgrade.png",
    "icon_researchabyss_buildequipment.png",
    "icon_researchabyss_upgradeequipment.png",
    "icon_oreCounter_1.png",
    "icon_oreCounter_1ref.png",
    "icon_oreCounter_2.png",
    "icon_oreCounter_2ref.png",
    "icon_autominerselect_tier0.png",
    "icon_upgrade_unlockminer1.png",
    "icon_popupmenu_buy.png",
    "icon_popupmenu_ok.png",
    "icon_popupmenu_back.png"
];
...
Main.pipeline = function () {         //this function contains the entire game and is called to start the game
    ...
    Main.Init = function () {         //this function initializes the game.
        ...
        Main.material_ore_1 = 0;
        Main.material_refined_1 = 0;
        Main.material_ore_2 = 0;
        Main.material_refined_2 = 0;
        ...
        Main.mineOre = function (tier, strength, amount) {                       //the method for clicking ONCE
            ...
            if (tier === 1) {                                        //determine possible ore and probability based on tier of player/miner
                chance_1 = e1 < 0.25;
                chance_2 = e1 >= 0.25;
                if (chance_2) {                             //if dice roll wins iron
                    Main.material_ore_1 += strength * amount;
                } else if (chance_1) {                         //if dice roll wins copper
                    Main.material_ore_2 += strength * amount;
                }
            }
        };
        ...
        */
        ...
        Main.object_popupmenu = function (/**/) {
            var docfrag, i, div_wrapper, div_popupmenu, toplevelwrapper, table, row, column;
            ...
            if (this.type === "upgrade") {
                var upgradeobject, texttitle, textdescription, canvas_buttonbuy, context,
                    costimage, costimage_getimgfunc, costspan;
                ...
                costimage_getimgfunc = function (upgradeobj, x) {    //helper function to get cost icons from upgrade costarray
                    if (upgradeobj.costarray[x][0] === "refined_1") {
                        return getImage(Main.Preloader, "icon_oreCounter_1ref.png");
                    } else if (upgradeobj.costarray[x][0] === "refined_2") {
                        return getImage(Main.Preloader, "icon_oreCounter_2ref.png");
                    }
                };
                ...
                canvas_buttonbuy.addEventListener("click", function (e) {
                    ...
                    if (!upgradeobject.costcheck()) {
                        ...
                        div_wrapper = document.getElementById("popupmenu_wrapper");     //close the popup
                        div_wrapper.parentNode.removeChild(div_wrapper);
                    }
                });
            ...
            if (this.type === "abyssslot") {
                ...
                div_resetdiver = document.createElement("div");
                div_resetdiver.style.display = "none";
                canvas_confirm = document.createElement("canvas");
                canvas_confirm.width = getImage(Main.Preloader, "icon_popupmenu_ok.png").width;
                canvas_confirm.height = getImage(Main.Preloader, "icon_popupmenu_ok.png").height;
                canvas_confirm.getContext("2d").drawImage(getImage(Main.Preloader, "icon_popupmenu_ok.png"), 0, 0);
                ...
                div_resetdiver.appendChild(canvas_confirm);
                div_popupmenu.appendChild(div_resetdiver);
                
                //popup if whichpopup === "select_equipment"
                div_selectequipment = document.createElement("div");
                div_selectequipment.style.display = "none";
                div_popupmenu.appendChild(div_selectequipment);
                //TODO: addEventListener to modify Main.abyssequipmentArray and objectabyssdiver.equipment array
                
                //popup if whichpopup === "refuel"
                div_refuel = document.createElement("div");
                div_refuel.style.display = "none";
                div_popupmenu.appendChild(div_refuel);
                //TODO: add functions
                
                //popup if whichpopup === "godive"
                div_godive = document.createElement("div");
                div_godive.style.display = "none";
                div_popupmenu.appendChild(div_godive);
                
                if (whichpopup === "reset_diver") {        //menustate = -1
                    div_popupmenu.className = "popupmenu_abyss_resetdiver";
                    div_resetdiver.style.display = "block";
                    div_selectequipment.style.display = "none";
                    div_refuel.style.display = "none";
                    div_godive.style.display = "none";
                }
                if (whichpopup === "select_equipment") {
                    div_popupmenu.className = "popupmenu_abyss_selectequipment";
                    div_resetdiver.style.display = "none";
                    div_selectequipment.style.display = "block";
                    div_refuel.style.display = "none";
                    div_godive.style.display = "none";
                }
                if (whichpopup === "refuel") {
                    div_popupmenu.className = "popupmenu_abyss_refuel";
                    div_resetdiver.style.display = "none";
                    div_selectequipment.style.display = "none";
                    div_refuel.style.display = "block";
                    div_godive.style.display = "none";
                }
                if (whichpopup === "godive") {
                    div_popupmenu.className = "popupmenu_abyss_godive";
                    div_resetdiver.style.display = "none";
                    div_selectequipment.style.display = "none";
                    div_refuel.style.display = "none";
                    div_godive.style.display = "block";
                }
            }
            if (this.type === "researchabyss_buildequipment") {
                var div_buildequipment_state0, span_buildequipment_title,
                    span_equipmenttier1,
                    div_buildequipment_state1, canvas_ok, canvas_back,
                    which_recipe;
                div_popupmenu = document.createElement("div");
                div_popupmenu.addEventListener("click", function (e) {
                    e.stopPropagation();
                });
                div_popupmenu.className = "popupmenu_researchabyss_buildequipment";
                //state 0 menu - choose recipe
                div_buildequipment_state0 = document.createElement("div");
                div_buildequipment_state0.style.display = "block";
                span_buildequipment_title = document.createElement("span");
                span_buildequipment_title.textContent = "Select a recipe:";
                div_buildequipment_state0.appendChild(span_buildequipment_title);
                
                table = document.createElement("table");
                row = document.createElement("tr");
                column = document.createElement("td");
                span_equipmenttier1 = document.createElement("span");   //t1 equipment entry
                span_equipmenttier1.textContent = "T1 armor";
                span_equipmenttier1.addEventListener("click", function () {
                    //TODO: add stats and shit for the new armor in next screen
                    div_buildequipment_state0.style.display = "none";
                    div_buildequipment_state1.style.display = "block";
                });
                column.appendChild(span_equipmenttier1);
                row.appendChild(column);
                table.appendChild(row);
                div_buildequipment_state0.appendChild(table);
                div_popupmenu.appendChild(div_buildequipment_state0);
                
                //state 1 menu - confirm or go back to 0
                div_buildequipment_state1 = document.createElement("div");
                div_buildequipment_state1.style.display = "none";
                canvas_ok = document.createElement("canvas");
                canvas_ok.width = getImage(Main.Preloader, "icon_popupmenu_ok.png").width;
                canvas_ok.height = getImage(Main.Preloader, "icon_popupmenu_ok.png").height;
                canvas_ok.addEventListener("click", function () {
                    //TODO: check cost, if cost is OK then add to equipment inventory array
                    div_wrapper = document.getElementById("popupmenu_wrapper");     //close the popup
                    div_wrapper.parentNode.removeChild(div_wrapper);
                });
                canvas_ok.getContext("2d").drawImage(getImage(Main.Preloader, "icon_popupmenu_ok.png"), 0, 0);
                div_buildequipment_state1.appendChild(canvas_ok);
                canvas_back = document.createElement("canvas");
                canvas_back.width = getImage(Main.Preloader, "icon_popupmenu_back.png").width;
                canvas_back.height = getImage(Main.Preloader, "icon_popupmenu_back.png").height;
                canvas_back.addEventListener("click", function () {
                    div_buildequipment_state0.style.display = "block";
                    div_buildequipment_state1.style.display = "none";
                });
                canvas_back.getContext("2d").drawImage(getImage(Main.Preloader, "icon_popupmenu_back.png"), 0, 0);
                div_buildequipment_state1.appendChild(canvas_back);
                div_popupmenu.appendChild(div_buildequipment_state1);
            }
        ...
        Main.researchmenuAbyss_logic = function () {
            var element_researchmenu, docfrag,
                div_researchmenu_wrapper, span_researchmenu_title, div_researchmenu_select,
                canvas_select_buildequipment, canvas_select_upgradeequipment;
            element_researchmenu = document.getElementsByClassName("researchMenuAbyss");
            if (!element_researchmenu[0].logicInitialized) {
                docfrag = document.createDocumentFragment();
                div_researchmenu_wrapper = document.createElement("div");       //wrapper
                div_researchmenu_wrapper.id = "researchMenu_div_researchmenuAbyss_wrapper";
                span_researchmenu_title = document.createElement("span");       //title
                span_researchmenu_title.className = "span_title";
                span_researchmenu_title.textContent = "Options";
                div_researchmenu_select = document.createElement("div");        //div that contains the select options
                div_researchmenu_select.id = "researchMenu_div_researchmenuAbyss_select";
                canvas_select_buildequipment = document.createElement("canvas");        //canvas for build equipment button
                canvas_select_buildequipment.id = "researchMenu_canvas_researchmenuAbyss_buildequipment";
                canvas_select_buildequipment.width = getImage(Main.Preloader, "icon_researchabyss_buildequipment.png").width;
                canvas_select_buildequipment.height = getImage(Main.Preloader, "icon_researchabyss_buildequipment.png").height;
                canvas_select_buildequipment.addEventListener("click", function () {
                    new Main.object_popupmenu("researchabyss_buildequipment");
                });
                div_researchmenu_select.appendChild(canvas_select_buildequipment);
                canvas_select_upgradeequipment = document.createElement("canvas");      //canvas for upgrade equipment button
                canvas_select_upgradeequipment.id = "researchMenu_canvas_researchmenuAbyss_upgradeequipment";
                canvas_select_upgradeequipment.width = getImage(Main.Preloader, "icon_researchabyss_upgradeequipment.png").width;
                canvas_select_upgradeequipment.height = getImage(Main.Preloader, "icon_researchabyss_upgradeequipment.png").height;
                //TODO: add click event to bring up popup to upgrade
                div_researchmenu_select.appendChild(canvas_select_upgradeequipment);
        ...
        Main.researchmenuAbyss_draw = function () {
            var ctx, img, element_researchmenu,
            canvas_select_buildequipment, canvas_select_upgradeequipment;
            element_researchmenu = document.getElementsByClassName("researchMenuAbyss");
            if (element_researchmenu[0].logicInitialized) {
                canvas_select_buildequipment = document.getElementById("researchMenu_canvas_researchmenuAbyss_buildequipment");
                ctx = canvas_select_buildequipment.getContext("2d");
                img = getImage(Main.Preloader, "icon_researchabyss_buildequipment.png");
                ctx.drawImage(img, 0, 0);

                canvas_select_upgradeequipment = document.getElementById("researchMenu_canvas_researchmenuAbyss_upgradeequipment");
                ctx = canvas_select_upgradeequipment.getContext("2d");
                img = getImage(Main.Preloader, "icon_researchabyss_upgradeequipment.png");
                ctx.drawImage(img, 0, 0);
            }
        };
        ...
        //menu buttons
        Main.object_button_save_logic = function () {
            var element_button;
            element_button = document.getElementsByClassName("button_save");
        ...
        Main.object_button_load_logic = function () {
            var element_button;
            element_button = document.getElementsByClassName("button_load");
            for (let i = 0; i < element_button.length; i += 1) {
                if (!element_button[i].logicInitialized) {
                    if (!element_button[i].hasListener) {
                        element_button[i].addEventListener("click", function () {
                ...
                if (!element_button[i].logicInitialized) {
                    if (!element_button[i].hasListener) {
                        element_button[i].addEventListener("click", function () {
                            ...
                            if (Main.HUDstateMenu !== 2) {
                                Main.changeToHUDMenu(2);
                            }
                        });
                        element_button[i].hasListener = 1;
                        element_button[i].logicInitialized = 1;
        ...
        Main.objectauto_abyssdiver_definefunctions = function (objectauto_abyssdiver) {
            ...
            if (typeof e.reset_to_default === "undefined") {
                e.reset_to_default = function () {
                    e.state = -1;         //menustate for diver slot
                    e.inventory = [];    //array that holds this diver's inventory.  will be populated with artifacts+count
                    e.targetdepth = 0;   //target depth of diver.
                    e.currentdepth = 0;  //when on a journey, where is the diver now?
                    e.farthestdepth = 0; //what is the furthest this diver has ever gone?
                    e.howmanydives = 0;  //how many successful dives has this diver been on?
                    e.rate = 1;          //how quickly does the diver dive per sec
                    e.equipment = [];    //array that holds this diver's equipment.  will be populated with armor type string.
                    e.tickCount = 0;     //tick counter that updates every second
                    e.name = "Charlemagne";  //what is this divers name?
                };
            }
        };
            ...
            if (!element_menuabysscontainer[0].logicInitialized) {
                if (Main.player_abyss_initialized) {
                    for (let i = 0; i < abyssArray.length; i += 1) {
                        ...
                        div_stateneg1.className = "abyssSlot_div_stateneg1";
                        ...
                        div_state0.className = "abyssSlot_div_state0";
                        div_state0.id = "abyssSlot_div_state0_" + i;
                        ...
                        parentdiv.appendChild(div_state0);
                ...
                for (i = 0; i < abyssArray.length; i += 1) {        //loop through all abyss objects
                    ...
                    div_state0 = document.getElementById("abyssSlot_div_state0_" + i);
                    if (e.state === -1) {
                    ...
                    if (e.state === 0) {
                        div_stateneg1.style.display = "none";
                        div_state0.style.display = "block";
                    }
                }
            }
        };
        ...
        Main.objectitem_abyssequipment = function (tier) {      //equipment equipped by divers, or placed in inventory
            this.tier = tier;          //determines up to what depth it works at
            this.upgradelevel = 0;      //determines what bonuses it gives.  starts at 0.
        };
        Main.abyssequipmentArray.push = new Main.objectitem_abyssequipment(1); 
            ...
            if (e.initialized) {        //if object is initialized...
                ...
                if (e.state === 3 || e.state === 4) {     //if there is an ore chosen and ores queued up, then turn on the furnace
                    ...
                    if (e.current_queue >= 0) {          //if that did not make the queue negative, perform mining operation
                        if (e.current_ore === "1") {
                            Main.material_ore_1 -= e.rate;     //smelt an ore from the player's stock
                            Main.material_refined_1 += e.rate;     //add it to the player's refined stock               //rate = ore/sec
                        } else if (e.current_ore === "2") {
                            Main.material_ore_2 -= e.rate;     //smelt an ore from the player's stock
                            Main.material_refined_2 += e.rate;     //add it to the player's refined stock     //rate = ore/sec
                        }
                        ...
                        if (difference > 0) {       //if this resulted in a positive number, then there is still ore to smelt
                            if (e.current_ore === "1") {
                                Main.material_ore_1 -= difference;    //this should make it 0
                                Main.material_ore_1 += difference;
                            } else if (e.current_ore === "2") {
                                Main.material_ore_2 -= difference;    //this should make it 0
                                Main.material_ore_2 += difference;
                            }
            ...
            if (!element_menurefinerycontainer[0].logicInitialized) {       //if refinery container is not initialized (just a blank div)
                if (Main.player_refinery_initialized) {     //only begin initialization if the refinery array is initialized
                    for (let i = 0; i < refineryObjectArray.length; i += 1) {      //for every refinery object in array...
                        ...
                        div1_imginput_ore1a.addEventListener("click", function () {
                            refineryObjectArray[i].current_ore = "1";
                        ...
                        div1_imginput_ore1b.addEventListener("click", function () {
                            refineryObjectArray[i].current_ore = "2";
                            refineryObjectArray[i].state = 2;
                        });
                        ...
                        div2_input.addEventListener("keypress", function (event) {
                            if (event.which === 13) {
                                if (refineryObjectArray[i].current_ore === "1") {
                                    if (div2_input.value <= Main.material_ore_1 && div2_input.value > 0) {
                                        refineryObjectArray[i].current_queue = div2_input.value;
                                        div2_input.value = null;
                                        refineryObjectArray[i].state = 3;
                                    }
                                }
                                if (refineryObjectArray[i].current_ore === "2") {
                                    if (div2_input.value <= Main.material_ore_2 && div2_input.value > 0) {
                                        refineryObjectArray[i].current_queue = div2_input.value;
                                        div2_input.value = null;
                                        refineryObjectArray[i].state = 3;
                                    }
                        ...
                        div2_imgall.addEventListener("click", function () {
                            if (refineryObjectArray[i].current_ore === "1") {
                                refineryObjectArray[i].current_queue = Main.material_ore_1;
                                refineryObjectArray[i].state = 3;
                            }
                            if (refineryObjectArray[i].current_ore === "2") {
                                refineryObjectArray[i].current_queue = Main.material_ore_2;
                                refineryObjectArray[i].state = 3;
                            }
                        });
                        ...
                        div4_input.addEventListener("keypress", function (event) {
                            if (event.which === 13) {
                                if (refineryObjectArray[i].current_ore === "1") {
                                    if (div4_input.value <= Main.material_ore_1 && div4_input.value > 0) {
                                ...
                                if (refineryObjectArray[i].current_ore === "2") {
                                    if (div4_input.value <= Main.material_ore_2 && div4_input.value > 0) {
                                        refineryObjectArray[i].current_queue = div2_input.value;
                                        div4_input.value = null;
                                        refineryObjectArray[i].state = 3;
                                    }
                        ...
                        div4_imgall.addEventListener("click", function () {
                            if (refineryObjectArray[i].current_ore === "1") {
                                if (refineryObjectArray[i].current_queue < Main.material_ore_1) {
                                    refineryObjectArray[i].current_queue = Main.material_ore_1;
                                    refineryObjectArray[i].state = 3;
                                }
                            }
                            if (refineryObjectArray[i].current_ore === "2") {
                                if (refineryObjectArray[i].current_queue < Main.material_ore_2) {
                                    refineryObjectArray[i].current_queue = Main.material_ore_2;
                                    refineryObjectArray[i].state = 3;
                                }
                            }
                ...
                for (j = 0; j < refineryObjectArray.length; j += 1) {       //for every refinery slot....
                    ...
                    if (e.state === 1) {
                        ...
                        div3.style.display = "none";
                        div4.style.display = "none";
                        if (Main.material_ore_1 <= 0) {       //show icon of ores in player's stock, hide them if player doesn't have them
                            div1_imginput_ore1a.style.display = "none";
                        } else {
                            div1_imginput_ore1a.style.display = "inline";
                        }
                        if (Main.material_ore_2 <= 0) {
                ...
                if (menurefinerycontainer[i].logicInitialized) {        //if logic function has built all the elements (avoids null pointers)
                    if (e[i].state === 1) {         //check state (which menu should be drawn)
                        ...
                        if (div1_imginput_ore1a.style.display !== "none") {
                            ...
                            img = getImage(Main.Preloader, "icon_refinery_ore1.png");
                            ctx.drawImage(img, 0, 0);
                        }
                        if (div1_imginput_ore1b.style.display !== "none") {
                            ctx = div1_imginput_ore1b.getContext("2d");
                            img = getImage(Main.Preloader, "icon_refinery_ore2.png");
                            ctx.drawImage(img, 0, 0);
                        }
                    }
                    if (e[i].state === 2) {
                        ...
                        if (e[i].current_ore === "1") {
                            img = getImage(Main.Preloader, "icon_refinery_ore1.png");
                        }
                        if (e[i].current_ore === "2") {
                            img = getImage(Main.Preloader, "icon_refinery_ore2.png");
                        }
                        ctx.drawImage(img, 0, 0);
        ...
        Main.object_oreCounter_logic = function () {
            ...
            if (!element_oreCounter[0].logicInitialized) {
                ...
                divtier1_canvasicon_ore1a.width = getImage(Main.Preloader, "icon_oreCounter_1.png").width;
                divtier1_canvasicon_ore1a.height = getImage(Main.Preloader, "icon_oreCounter_1.png").height;
                ...
                divtier1_canvasicon_ore1b.width = getImage(Main.Preloader, "icon_oreCounter_2.png").width;
                divtier1_canvasicon_ore1b.height = getImage(Main.Preloader, "icon_oreCounter_2.png").height;
                ...
                divtier1_canvasicon_ref1a.width = getImage(Main.Preloader, "icon_oreCounter_1ref.png").width;
                divtier1_canvasicon_ref1a.height = getImage(Main.Preloader, "icon_oreCounter_1ref.png").height;
                ...
                divtier1_canvasicon_ref1b.width = getImage(Main.Preloader, "icon_oreCounter_2ref.png").width;
                divtier1_canvasicon_ref1b.height = getImage(Main.Preloader, "icon_oreCounter_2ref.png").height;
                ...
                span_ore.textContent = Main.material_ore_1 + Main.material_ore_2 + " ores";
                if (divtier1.style.display != "none") {
                    divtier1_span_ore1a.textContent = Main.material_ore_1;
                    divtier1_span_ore1b.textContent = Main.material_ore_2;
                    divtier1_span_ref1a.textContent = Main.material_refined_1;
                    divtier1_span_ref1b.textContent = Main.material_refined_2;
                }
            }
        };
        ...
        Main.object_oreCounter_draw = function () {
            ...
            if (element_oreCounter[0].logicInitialized) {
                ...
                if (Main.player_oreCountermenu === 1) {
                    ...
                    img = getImage(Main.Preloader, "icon_oreCounter_1.png");
                    ctx.drawImage(img, 0, 0);
                    ctx = divtier1_canvasicon_ore1b.getContext("2d");
                    img = getImage(Main.Preloader, "icon_oreCounter_2.png");
                    ctx.drawImage(img, 0, 0);
                    ctx = divtier1_canvasicon_ref1a.getContext("2d");
                    img = getImage(Main.Preloader, "icon_oreCounter_1ref.png");
                    ctx.drawImage(img, 0, 0);
                    ctx = divtier1_canvasicon_ref1b.getContext("2d");
                    img = getImage(Main.Preloader, "icon_oreCounter_2ref.png");
                    ctx.drawImage(img, 0, 0);
                } else {
                    divtier1.style.display = "none";
                }
            ...
            if (typeof object_upgrade.converttocheckarray === "undefined") {
                object_upgrade.converttocheckarray = function (whicharray) {
                    ...
                    object_upgrade.arraytocheck = whicharray.map(function (array_elements) {
                        if (array_elements[0] === "refined_1") {
                            return [Main.material_refined_1, array_elements[1]];
                        } else if (array_elements[0] === "refined_2") {
                            return [Main.material_refined_2, array_elements[1]];
                        } 
                    });
                };
            }
            if (typeof object_upgrade.chargecost === "undefined") {
                object_upgrade.chargecost = function () {
                    ...
                    for (i = 0; i < object_upgrade.costarray.length; i += 1) {
                        ...
                        if (vartocheck === "refined_1") {
                            Main.material_refined_1 -= costvalue;
                        } else if (vartocheck === "refined_2") {
                            Main.material_refined_2 -= costvalue;
                        }
                    }
                };
            }
        ...
        Main.saveGame = function () {
            ...
            //second level currency
            save_material_ore_1: Main.material_ore_1,
            save_material_refined_1: Main.material_refined_1,
            save_material_ore_2: Main.material_ore_2,
            save_material_refined_2: Main.material_refined_2,
            ...
            save_abyssdiverArray: Main.abyssdiverArray,              //abyss array that holds cave diver objects.
            save_abyssequipmentArray: Main.abyssequipmentArray,          //abyss array that holds equipment when not on a diver.
            save_player_abyss_initialized: Main.player_abyss_initialized,     //determines if abyss arrays are ready.  starts at 0;
            save_player_abyss_slotcount: Main.player_abyss_slotcount        //number of abyss divers player can have.  starts at 1;
            };
        ...
        Main.loadGame = function () {
            ...
            //second level currency
            Main.material_ore_1 = checkifundef(Main.material_ore_1, savedgamefile.save_material_ore_1);
            Main.material_refined_1 = checkifundef(Main.material_refined_1, savedgamefile.save_material_refined_1);
            Main.material_ore_2 = checkifundef(Main.material_ore_2, savedgamefile.save_material_ore_2);
            Main.material_refined_2 = checkifundef(Main.material_refined_2, savedgamefile.save_material_refined_2);
            ...
            //abyss
            Main.abyssdiverArray = checkifundef(Main.abyssdiverArray, savedgamefile.save_abyssdiverArray);              //abyss array that holds cave diver objects.
            for (i = 0; i < Main.abyssdiverArray.length; i += 1) {
                Main.objectauto_abyssdiver_definefunctions(Main.abyssdiverArray[i]);
            }
            Main.abyssequipmentArray = checkifundef(Main.abyssequipmentArray, savedgamefile.save_abyssequipmentArray);           //abyss array that holds equipment when not on a diver.
            Main.player_abyss_initialized = checkifundef(Main.player_abyss_initialized, savedgamefile.save_player_abyss_initialized);     //determines if abyss arrays are ready.  starts at 0;
            Main.player_abyss_slotcount = checkifundef(Main.player_abyss_slotcount, savedgamefile.save_player_abyss_slotcount);        //number of abyss divers player can have.  starts at 1;
        ...
        Main.HUDbuildMenu = function (statemenu) {
            ...
            if (statemenu === 0) {                              //if requested to initialize mining menu...
                Main.HUDmenuTotalObjects = 8;                  //number of objects that need to be loaded for this specific menu
                ...
                Main.HUDObjectInitialize(new Main.Object(0, "button_save", "AreaSelect", "button_save.png", Main.object_button_save_logic));
                Main.HUDObjectInitialize(new Main.Object(0, "button_load", "AreaSelect", "button_load.png", Main.object_button_load_logic));
            ...
            if (statemenu === 2) {                              //if requested to initialize mining menu...
                Main.HUDmenuTotalObjects = 8;                  //number of objects that need to be loaded for this specific menu
                Main.HUDObjectInitialize(new Main.Object(0, "button_mines", "AreaSelect", "button_mines.png", Main.object_button_mines_logic));
                Main.HUDObjectInitialize(new Main.Object(0, "button_abyss", "AreaSelect", "button_abyss.png", Main.object_button_abyss_logic));
                Main.HUDObjectInitialize(new Main.Object(0, "button_refinery", "AreaSelect", "button_refinery.png", Main.object_button_refinery_logic));
                Main.HUDObjectInitialize(new Main.Object(2, "oreCounter", "statisticsleft", "no image", Main.object_oreCounter_logic, Main.object_oreCounter_draw));
                Main.HUDObjectInitialize(new Main.Object(2, "researchMenuAbyss", "research", "no_image", Main.researchmenuAbyss_logic, Main.researchmenuAbyss_draw));
                Main.HUDObjectInitialize(new Main.Object(2, "infoPlayer", "information", "no image", Main.information_player_logic, Main.information_player_draw));
                Main.HUDObjectInitialize(new Main.Object(0, "button_save", "AreaSelect", "button_mines.png", Main.object_button_save_logic));
                Main.HUDObjectInitialize(new Main.Object(0, "button_load", "AreaSelect", "button_abyss.png", Main.object_button_load_logic));
        ...
        Main.clearHUDMenu = function (targetarray) {          //function to clear the menu (before switching menu)
            var i, j, k, target, parent, children, props;
            for (i = 0; i < targetarray.length; i += 1) {      //loop through every object in the object array and delete the elements
                target = targetarray[i];                           //set the target object
                parent = document.querySelectorAll("#" + target.parentid)[0];          //get the parent element from target object
            ...
            Main.HUDmenuInitialized = 0;                                   //declare the menu not initialized
        };
        ...
        Main.changeToHUDMenu = function (statemenu_next) {
            ...
            Main.clearHUDMenu(Main.HUDmenuObjectArray);                       //clear menu of all objects and elements specific to menu
